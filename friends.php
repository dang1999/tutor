...
<?php
  ...
  // $row = $post->select_by_id('*', 4);
  // GET LIST
  $row = $post->get_list('select * from post');

  // $row = $post->get_row('select * from post where post_id = 1');
?>
  ...
  <div class="row content">
    <div class="col-sm-3 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li class="nav-link active"><a href="friends.php">Posts</a></li>
    ...
    <div class="col-sm-9">
     ...
     <?php foreach($row as $k => $v):?>
      ...
      <h2><?php echo $v["tiltle"];?></h2>
      <h5><span class="glyphicon glyphicon-time"></span> Post by Jane Dane, <?php echo $v["datetime"];?>.</h5>
