...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9">
      <h4><a href="new_post.html">New Post</a></h4>
      ...
      <form role="form" action="add_comment.php" id="comment_form" method="POST">
        <div class="form-group" id="comment-group">
        <input type="text" class="form-control" name="comment_content" placeholder="Henry Pym">
